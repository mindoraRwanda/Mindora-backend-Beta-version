...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.addColumn("mood_logs", "logDate", {
    ...
    await queryInterface.sequelize.query(
      'UPDATE "mood_logs" SET "logDate" = $1 WHERE "logDate" IS NULL;',
      {
    ...
    await queryInterface.changeColumn("mood_logs", "logDate", {
      type: Sequelize.DATEONLY,
  ...
  async down(queryInterface, Sequelize) {
    await queryInterface.removeColumn("mood_logs", "logDate");
  },
};
